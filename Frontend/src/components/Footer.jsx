  ...
  return (
    <footer>
      ...
      <div className="social-icons">
        ...
        <a href="https://web.facebook.com/bunie.creatives" target="_blank" rel="noopener noreferrer" title="Facebook">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <a href="https://www.instagram.com/bunie_creatives" target="_blank" rel="noopener noreferrer" title="Instagram">
